# the user's Regeln (Original-Wortlaut, diktiert 2026-03-10)
...
Von dieser Prioritaet wird NUR abgewichen wenn the user explizit darum bittet.
...
- Taeglich ein Roundtable der sich NUR mit neuen Features beschaeftigt die ueber the user's Befehle/Ideen hinausgehen
